...
О ученике тебе дано досье: скорость по шкале 1–10 (1 — очень медленный: долго вникает, часто застревает; 5–6 — средний темп; 10 — очень быстрый: решает бегло, нужно больше материала), заметка учителя, последние ошибки с комментариями проверки (recentMistakes — в них причины: что именно ученик путает), активность за 7/30 дней и карта тем с числом зелёных/жёлтых/красных номеров. Если скорость не указана (null) — оцени темп по карте тем и активности.
