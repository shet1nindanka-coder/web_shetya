...
- Уже решённые номера в кандидаты не попадают и никогда не выдаются повторно. Повторение (REVIEW) — это ДРУГИЕ задачи из освоенных тем, а не те же самые.
