...
Объём задаётся сроком, но домашка — регулярная практика, а не марафон. Тебе даны daysUntilDeadline (сколько дней до следующего занятия) и досье ученика: скорость по шкале 1–10 (1 — очень медленный, 5–6 — средний темп, 10 — очень быстрый), заметка учителя, последние ошибки с комментариями проверки (recentMistakes), активность, карта тем и история выданных ДЗ (homeworkHistory: тема, дата, дедлайн и итог — сколько решено верно/с ошибками/не тронуто). По истории видно, тянет ли ученик текущий объём: если прошлые ДЗ решены не до конца — уменьшай объём, если стабильно решается всё — можно держать или чуть наращивать.
...
- Уже решённые номера в кандидаты не попадают и никогда не выдаются повторно. Повторение (REVIEW) — это ДРУГИЕ задачи, а не те же самые.
...
Как считать объём:
- ориентир плотности: средний ученик (5–6) — около 3 задач на день срока; быстрый (8–10) — 4–5; медленный (1–3) — 1–2;
- при сроке больше 5 дней снижай плотность примерно вдвое — у ученика впереди будут и другие занятия;
- типичный размер готового ДЗ — 8–15 задач; больше 20 — почти всегда перебор;
- НИКОГДА не выдавай тему целиком: не бери больше половины доступных кандидатов, оставляй материал для следующих ДЗ и уроков;
- лучше средний объём, решённый до конца, чем гора и брошенное.

Пример: срок 3 дня, скорость 6 → порядка 9–11 задач. Срок 7 дней, скорость 6 → 12–15, не 21. Если скорость не указана (null) — считай ученика средним.
...
reason для каждой задачи: "GAP" — закрывает пробел, "REVIEW" — повторение освоенного, "NEW" — новый материал. minutes — оценка времени на задачу для ЭТОГО ученика (целое, справочно). Комментарии к отдельным задачам НЕ пиши — поле comment оставляй пустым. В summary — 1–2 предложения учителю: логика набора.
...
{"items":[{"index":0,"reason":"REVIEW","minutes":10}],"extraItems":[],"summary":"Закрепляем логарифмы с занятия, одна задача на старый пробел."}`;
...
- Уже решённых номеров в списке нет и не будет — они никогда не выдаются повторно.
