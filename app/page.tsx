  ...
  return (
    <main className="soft-grid relative overflow-hidden">
      ...
      <div className="content-shell mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <header className="ui-surface mb-8 flex flex-col gap-4 rounded-[20px] border px-5 py-4 backdrop-blur lg:flex-row lg:items-center lg:justify-between">
          ...
          <Link
            href="/login"
            className="ui-pressable ui-button-primary inline-flex items-center justify-center rounded-[14px] px-5 py-3 text-sm font-semibold transition"
          >
            Войти
          </Link>
        </header>

        <section className="ui-surface relative overflow-hidden rounded-[28px] border px-5 py-8 backdrop-blur sm:px-7 lg:px-10 lg:py-10">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/login"
                  className="ui-pressable ui-button-primary inline-flex items-center justify-center rounded-[16px] px-6 py-3.5 text-sm font-semibold transition"
                >
                  Открыть кабинет
                </Link>
                <a
                  href="#about"
                  className="ui-pressable ui-button-secondary inline-flex items-center justify-center rounded-[16px] px-6 py-3.5 text-sm font-semibold transition"
                >
                  Коротко о платформе
                </a>
              </div>
            ...
            <div className="ui-fade-slide rounded-[24px] border border-[rgba(15,23,42,0.08)] bg-[var(--theme-hero)] p-6 text-white shadow-[0_24px_60px_rgba(15,23,42,0.16)]">
              <h2 className="font-display text-3xl font-semibold">Один понятный контур работы</h2>

              <div className="mt-6 space-y-3">
                <div className="rounded-[18px] border border-white/10 bg-white/10 px-4 py-4">
        ...
        <section id="about" className="mt-8 grid gap-4 md:grid-cols-3">
          {valueCards.map((card) => (
            <article key={card.title} className="ui-fade-slide ui-surface rounded-[22px] border p-6">
        ...
        <section className="ui-surface mt-8 rounded-[24px] border px-6 py-8 text-center">
