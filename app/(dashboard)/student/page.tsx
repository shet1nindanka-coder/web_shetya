    ...
    <div className="space-y-8">
      <section className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="page-header-panel rounded-[28px] border border-white/70 bg-slate-950 px-5 py-6 text-white shadow-glow sm:rounded-[36px] sm:px-6 sm:py-8">
          <h1 className="font-display text-3xl font-semibold sm:text-4xl">Ваш прогресс, темы и полезная инфа по ЕГЭ</h1>
      ...
      >
        <div className="grid gap-4 lg:grid-cols-2">
          <article className="ui-fade-slide ui-surface rounded-[28px] border border-slate-200 bg-slate-50/80 p-5 shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
            <h2 className="font-display text-2xl font-semibold text-slate-950">Открыть файлы и отметить номера</h2>
            <p className="mt-3 text-sm leading-6 text-slate-600">
          ...
          <article className="ui-fade-slide ui-surface rounded-[28px] border border-slate-200 bg-slate-50/80 p-5 shadow-[0_12px_35px_rgba(15,23,42,0.06)]">
            <h2 className="font-display text-2xl font-semibold text-slate-950">Перевод баллов и разбалловка</h2>
            <p className="mt-3 text-sm leading-6 text-slate-600">
