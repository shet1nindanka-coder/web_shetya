        ...
        <form
          ...
          onSubmit={(event) => {
            ...
            startTransition(async () => {
              try {
                const response = await fetch(`/api/student/topics/find-number?number=${encodeURIComponent(String(nextNumber))}`, {
                  method: "GET",
                  cache: "no-store"
                });
        ...
        >
          <label className="relative block">
            ...
            <input
              ...
              aria-describedby={feedback ? "student-number-search-feedback" : undefined}
          ...
          {feedback ? (
            <p
              id="student-number-search-feedback"
