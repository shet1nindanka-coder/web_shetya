...
export function SectionCard({
  ...
  return (
    <section
      className={cx(
        "ui-section-card ui-fade-slide ui-surface rounded-[14px] border p-3.5 sm:rounded-[18px] sm:p-4 lg:rounded-[20px] lg:p-5",
        className
      )}
    >
      <div className="ui-section-card-header mb-3.5 flex flex-col gap-2.5 border-b pb-3.5 sm:mb-4 lg:flex-row lg:items-end lg:justify-between">
